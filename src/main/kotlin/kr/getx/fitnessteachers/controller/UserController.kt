...
class UserController(
    ...
    fun userTypeEdit(@RequestBody updateUserRequest: UserDto): ResponseEntity<User> =
        ResponseEntity.ok(userService.processUserTypeEdit(updateUserRequest))

    @PostMapping("/edit/{email}")
    fun editUser(@PathVariable email: String, @RequestBody updateUserRequest: UserDto): ResponseEntity<User> =
        ResponseEntity.ok(userService.processUserEdit(email, updateUserRequest))
